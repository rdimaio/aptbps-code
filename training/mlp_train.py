...
def prepare_data_loaders(n_parts=2):
    ...
    if not os.path.exists(BPS_CACHE_FILE):
        ...
        xtr_bps = aptbps.adaptive_encode(xtr_normalized, n_parts=n_parts, n_bps_points=N_BPS_POINTS, bps_cell_type='dists', radius=BPS_RADIUS)
        print("converting test..")
        xte_bps = aptbps.adaptive_encode(xte_normalized, n_parts=n_parts, n_bps_points=N_BPS_POINTS, bps_cell_type='dists', radius=BPS_RADIUS)
